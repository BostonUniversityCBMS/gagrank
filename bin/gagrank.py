...
def rank_gags(gf, gc, cn, rf, mz, z, sl, a=None, db_path='../lib/GAGfragDB.db'):	
	...
	print("Loading GAGfinder results file...", end="")
	...
	print("Determining precursor composition...", end="")
	...
	print("Determining reducing end/non-reducing end information...", end="")
	...
	print("Generating possible backbones and modification positions...", end="")
	...
	print("Generating possible GAG structures...", end="")
	...
	print("Building bipartite graph...", end="")
	...
	print("Calculating enrichment score for each GAG structure...", end="")
...
def write_result_to_file(input_path, scores):
	print("Printing output to file...", end="")
